...
//    /**
//     * 通过 交换器 和 roukey 给 消息队列发送消息
//     * @param topicExchangeName
//     * @param roukey
//     * @param msg
//     */
//    public void sendToExchange(String topicExchangeName,String roukey,Object msg){
//        if (ObjectUtils.isNotNull(topicExchangeName)&&ObjectUtils.isNotNull(roukey)){
//            rabbitTemplate.convertAndSend(topicExchangeName, roukey, msg);
//        }
//    }
